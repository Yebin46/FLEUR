...
def compute_human_correlation(base_fold, ann_file, args, tauvariant='c'):
    data = {}
...
def main(args):
    ...
    compute_human_correlation(args.base_fold, args.input_json_c, args, tauvariant='c')

    # print('Flickr8K CrowdFlower (Tau-b)')
    # compute_human_correlation(args.base_fold, args.input_json_b, args, tauvariant='b')
